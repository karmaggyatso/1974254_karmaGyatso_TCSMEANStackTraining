...
function addToCartClicked(event) {
    ...
    addToCart["title"] = shopItem.getElementsByClassName("item-title")[0].innerText;
    addToCart["price"] = shopItem.getElementsByClassName("item-price")[0].innerText;
...
function addItemToCart(retrieveObj) {
    ...
    for (var i = 0; i < displayObjcart.length; i++) {
